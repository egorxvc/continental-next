            ...
            <div className="container  mx-auto py-16 md:py-32">
                ...
                <div className="flex flex-col lg:flex-row gap-2 md:gap-8 ">
                    <div className="lg:flex-shrink-0">
                        ...
                        <Image className="hidden md:block" src={"/img/history/history-img-2.png"} alt={"History"} width={465} height={363} />
                    </div>
                    <div className="w-full xl:max-w-4xl">
                        ...
                        <div className="bg-black text-white p-6 mb-16">
                            <p className="body">
