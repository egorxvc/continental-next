...
export default function PricesSection() {
    ...
    return (
    <div className="overflow-x-hidden py-16 md:py-32"  >
            <MotionConfig transition={{
                ...
                <motion.div
                    ...
                    drag={"x"} dragConstraints={{left:0, right: 0}} className="relative max-w-screen-xl mx-auto h-min">
                    <div
...
//                     <div
//                         key={idx}
//                         className="parallelogram-md flex-1 bg-accent text-white container text-whiteshadow p-8 px-16">
